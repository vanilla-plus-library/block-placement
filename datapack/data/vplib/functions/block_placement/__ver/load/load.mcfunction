#> vplib:block_placement/__ver/load/load
# From: 'vplib:block_placement/__ver/load/resolve'
...
# DEBUG Message
tellraw @a[tag=vplib.debug] [{"text":"[Debug]: ","color":"yellow","bold":true},{"text":"Loaded Vanilla+ Library: Block Placement __ver","color":"white","bold":false}]
