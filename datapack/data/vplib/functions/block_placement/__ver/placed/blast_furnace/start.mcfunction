#> vplib:block_placement/__ver/placed/blast_furnace/start
...
execute anchored eyes positioned ^ ^ ^ run function vplib:block_placement/__ver/placed/blast_furnace/raycast
