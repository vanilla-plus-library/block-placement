...
execute if block ^ ^ ^-0.5 #vplib:block_placement/__ver/valid_to_replace run scoreboard players set #replace_block vplib.temp 1


# The block must be valid
execute if score #replace_block vplib.temp matches 0 unless block ~ ~ ~ #vplib:block_placement/__ver/valid_to_place run scoreboard players set #valid vplib.temp 0

# No significant entities in the block
execute if score #replace_block vplib.temp matches 0 align xyz if entity @e[type=!#vplib:block_placement/__ver/ignore_to_place,dx=0,limit=1] run scoreboard players set #valid vplib.temp 0
execute if score #replace_block vplib.temp matches 1 positioned ^ ^ ^-0.5 align xyz if entity @e[type=!#vplib:block_placement/__ver/ignore_to_place,dx=0,limit=1] run scoreboard players set #valid vplib.temp 0
