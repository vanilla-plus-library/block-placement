#> vplib:block_placement/v1/placed/soul_campfire/start
...
execute anchored eyes positioned ^ ^ ^ run function vplib:block_placement/v1/placed/soul_campfire/raycast
